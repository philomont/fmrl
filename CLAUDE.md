...
- **Erosion** (`age_type=0`): Morphological erosion + short-run elimination (`age_by_erosion`)
- **Consolidation** (`age_type=1`): Progressive block merging (`age_by_consolidation`)
- **Bleach** (`age_type=2`): Convolutional pattern detection (`age_by_bleaching`)
